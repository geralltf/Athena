...
//{
	...
	{
		Vector4 x = Vector4(1.0, 0.0, 0.0, 0.0);
		Vector4 y = Vector4(0.0, 1.0, 0.0, 0.0);
		Vector4 z = Vector4(0.0, 0.0, 1.0, 0.0);
		Vector4 w = Vector4(0.0, 0.0, 0.0, 1.0);

		Matrix4 identity(x, y, z, w);
		return identity;
	}
